...
Extend Cline with reusable, on-demand instruction sets for specialized tasks.
...
> **Note**: Skills is an experimental feature. Enable it in **Settings → Features → Enable Skills**.
