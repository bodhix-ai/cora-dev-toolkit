...
| **P1** | D (Tooling) | **Infrastructure Validation** | *(new context needed)* | None | Prevents infrastructure interface mismatches (module-eval-opt incident) | **Low** (new validator only) | - | 🟡 Active |
