...
CREATE TABLE IF NOT EXISTS public.kb_access_orgs (
    ...
    CONSTRAINT kb_access_orgs_unique UNIQUE (kb_id, org_id)
);

-- Indexes
CREATE INDEX IF NOT EXISTS idx_kb_access_orgs_kb_id ON public.kb_access_orgs(kb_id);
CREATE INDEX IF NOT EXISTS idx_kb_access_orgs_org_id ON public.kb_access_orgs(org_id);
CREATE INDEX IF NOT EXISTS idx_kb_access_orgs_is_enabled ON public.kb_access_orgs(is_enabled) WHERE is_enabled = true;
