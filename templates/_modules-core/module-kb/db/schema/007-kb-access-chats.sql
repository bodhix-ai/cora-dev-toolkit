...
CREATE TABLE IF NOT EXISTS public.kb_access_chats (
    ...
    CONSTRAINT kb_access_chats_unique UNIQUE (kb_id, chat_session_id)
);

-- Indexes
CREATE INDEX IF NOT EXISTS idx_kb_access_chats_kb_id ON public.kb_access_chats(kb_id);
CREATE INDEX IF NOT EXISTS idx_kb_access_chats_chat_id ON public.kb_access_chats(chat_session_id);
CREATE INDEX IF NOT EXISTS idx_kb_access_chats_enabled ON public.kb_access_chats(chat_session_id, is_enabled) 
