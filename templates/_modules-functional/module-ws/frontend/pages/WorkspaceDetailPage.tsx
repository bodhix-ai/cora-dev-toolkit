...
// ============================================================================
// MODULE-KB INTEGRATION (Optional)
// When module-kb is available, import and use real KB components:
//
// import {
//   WorkspaceDataKBTab,
//   useKnowledgeBase,
...
//
// Then replace the mock KB section in the Data tab with:
// <WorkspaceDataKBTab
      ...
      <Paper sx={{ mb: 3 }}>
        ...
        <TabPanel value={activeTab} index={1}>
          ...
          {/* ================================================================
              ...
              This section shows mock KB data for demonstration.
              When module-kb is integrated, replace this entire section with:
              ...
              The WorkspaceDataKBTab component from module-kb provides:
              - KB toggle selector (enable/disable org and global KBs)
          ...
          <Box>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
              ...
              {" "}
              <em>(Demo data - integrate module-kb for real KB functionality)</em>
            </Typography>
