# Module Eval Infrastructure - Input Variables
...
variable "create_export_bucket" {
  description = "Whether to create a new S3 bucket for exports (set false to use existing bucket)"
  type        = bool
  default     = true
}

variable "export_bucket_name" {
  description = "Name of existing S3 bucket for exports (only used if create_export_bucket = false)"
  type        = string
  default     = ""
}

variable "export_bucket_arn" {
  description = "ARN of existing S3 bucket for exports (only used if create_export_bucket = false)"
  type        = string
  default     = ""
}
