...
/**
 * @component OrgsRedirectComponent
 * @description Organizations List Redirect Component
 * 
 ...
 * 
 * @routes
 * - GET /admin/sys/access/orgs - Redirect to organizations list
 */
export function OrgsRedirectComponent() {
...
export default OrgsRedirectComponent;