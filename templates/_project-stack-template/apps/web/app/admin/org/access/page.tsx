 ...
 * 
 * Allows org admins to view users in their organization.
 * Allows org owners to manage user roles and remove users.
 * 
 * Authentication: Pattern A (useUser hook)
