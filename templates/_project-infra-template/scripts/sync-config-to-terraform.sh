...
if [[ ! -f "$CONFIG_FILE" ]]; then
  ...
  echo ""
  log_error "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
  log_error "  SETUP REQUIRED: Create Project Configuration"
  log_error "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
  echo ""
  log_info "Before deploying, you need to create a project-specific config file."
  echo ""
  ...
  echo ""
  echo "  3. Edit the new config file with your actual credentials:"
  echo "     code setup.config.${PROJECT_NAME}.yaml"
  echo "     # Or use: nano setup.config.${PROJECT_NAME}.yaml"
  echo ""
  echo "  4. Fill in required values (see setup.config.example.yaml for details):"
  echo "     • Supabase credentials (url, keys, jwt_secret)"
  echo "     • Okta/Clerk auth configuration"
  echo "     • GitHub organization and repositories"
  echo "     • AWS profile"
  echo ""
  ...
  echo "     The setup.config.${PROJECT_NAME}.yaml file contains your"
  echo "     environment-specific credentials and configuration. It's not"
  echo "     included in the template to keep secrets out of version control."
  echo ""
  log_error "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
  echo ""
  exit 1
